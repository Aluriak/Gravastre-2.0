...
**
** Created: Sun Jun 3 18:14:29 2012
...
static const char qt_meta_stringdata_fenetre[] = {
    "fenetre\0\0ChangementECH()\0nvPas\0"
    "ChangementPas(int)\0Lancer_PRGM()\0"
};
...
int fenetre::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: ChangementECH(); break;
        case 1: ChangementPas((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: Lancer_PRGM(); break;
        default: ;
        }
        _id -= 3;
    }
